...
public class CommonWrapperMethodExamples {
    ...
    public static void main(String[] args){
        ...
        int myPrimInt = Integer.valueOf(5); // Compiler shows an error with unecessary boxing
        ...
        Integer myIntegerWrapper = Integer.valueOf(5); // Compiler shows an error with unecessary boxing
